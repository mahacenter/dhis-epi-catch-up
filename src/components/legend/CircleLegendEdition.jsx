...
const query = {
    dataElements: {
        ...
        params: appConfig => ({
            ...
            filter: `dataElementGroups.id:eq:${appConfig.immunizationDataGroup}`,
            paging: 'false',
        }),
    },
};
...
function CircleLegendEdition(props) {
    ...
    if (_.isEmpty(data.dataElements.dataElements))
                ...
                <>
                    ...
                    <FormControl>
                        <Box display='flex' alignItems='center' mt={2}>
                            <Box mr={3} className='xs-hidden'>
                                Opacity
                            </Box>
                            <Box mr={3}>
                                <VisibilityOffIcon opacity={0.6} />
                            </Box>
                            <Slider
                                value={opacity}
                                min={0}
