...
export const customIndicatorById = _.keyBy(
    customIndicators,
    indicator => indicator.id
);
export const customIndicatorsByGroup = _.groupBy(
    customIndicators,
    indicator => indicator.group
);
export const customLegendById = _.keyBy(
    customIndicators,
    indicator => indicator.legendSet.id
);
